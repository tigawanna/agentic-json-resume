    ...
    >
      <div className="relative flex min-h-full flex-col">
        ...
        <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 py-16">
          <div className="flex w-full max-w-3xl flex-col items-center gap-10 md:flex-row md:items-center md:justify-center md:gap-14">
            <SiteIcon size={128} className="shrink-0 md:self-start md:mt-3" aria-hidden />

            <div className="flex flex-col items-center text-center md:items-start md:text-left">
              <p className="font-serif text-[clamp(4.5rem,14vw,7.5rem)] leading-none tracking-[-0.04em] text-base-content">
                404
              </p>
