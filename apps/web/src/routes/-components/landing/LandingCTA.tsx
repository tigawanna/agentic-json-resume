...
export function LandingCTA() {
  ...
  return (
    <section
      ...
      className="mx-auto max-w-360 border-x border-border/50"
    >
      <div className="border-t border-border/50 px-8 py-24 md:px-16">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mx-auto mb-10 max-w-md text-muted-foreground">
            Sign in to open the dashboard, paste or upload your schema, and iterate
            toward PDF export. Or try the public editor — no account needed.
          </p>
