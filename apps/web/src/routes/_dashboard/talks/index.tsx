...
export const Route = createFileRoute("/_dashboard/talks/")({
  component: RouteComponent,
  head: () => ({
    meta: [{ title: "Talks", description: "Manage your talks and presentations" }],
  }),
  ssr: false,
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1 text-sm">
            Talks and presentations across all your resumes.
          </p>
        </div>
      </div>
      <SearchBox
        ...
        inputProps={{ placeholder: "Search talks..." }}
      />
