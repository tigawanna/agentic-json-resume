...
const ApiAiEventSourcedResumeTailorRoute =
  ApiAiEventSourcedResumeTailorRouteImport.update({
...
const EventSourcedResumesResumeIdIndexRoute =
  EventSourcedResumesResumeIdIndexRouteImport.update({
    id: '/resumes/$resumeId/',
